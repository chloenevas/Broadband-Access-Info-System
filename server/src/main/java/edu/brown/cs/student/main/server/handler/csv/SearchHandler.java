rpackage edu.brown.cs.student.main.server.handler.csv;
...
public class SearchHandler implements Route {
    ...
    public Object handle(Request request, Response response) {
        ...
        Boolean hasHeader = Boolean.valueOf(request.queryParams("header"));
        ...
        try {
            ...
            if(column == null || column.isEmpty()){
                searcher =
                    new Searcher(target, this.sharedData.getProxyData(), hasHeader);
            } else{
                searcher =
                    new Searcher(target, this.sharedData.getProxyData(), column, hasHeader);
            ...
            if(searcher.search().isEmpty()){
                ...
                searchMap.put("details", "No results were found. Please check that you are searching "
                    ...
                    + ". Otherwise, search for a new value.");
            } else{
